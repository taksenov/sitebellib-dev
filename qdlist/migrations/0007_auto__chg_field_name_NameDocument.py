...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'name.NameDocument'
        db.alter_column(u'qdlist_name', 'NameDocument', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'name.NameDocument'
        db.alter_column(u'qdlist_name', 'NameDocument', self.gf('django.db.models.fields.CharField')(max_length=10))
