...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'subtype.linktypename'
        db.alter_column(u'qdlist_subtype', 'linktypename', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'subtype.linktypename'
        db.alter_column(u'qdlist_subtype', 'linktypename', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
    ...
    models = {
        ...
        u'qdlist.subtype': {
            ...
            'linktypename': ('django.db.models.fields.CharField', [], {'default': "'s'", 'max_length': '1'}),
